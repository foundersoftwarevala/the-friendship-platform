...
export type EntityStatus =
  "active" | "inactive" | "draft" | "pending" | "suspended" | "archived" | "deleted";
...
export function useSystemActions() {
  ...
  const executeAction = useCallback(
    async <T = unknown>(
      ...
      try {
        ...
        // Show success toast
        const successMsg =
          config.successMessage || `${config.entityType} ${config.action}d successfully`;
  ...
  const proceedWithAction = useCallback(
    async <T = unknown>(handler?: () => Promise<T>): Promise<SystemActionResult<T> | null> => {
  ...
  const actions = {
    // CRUD Operations
    create: useCallback(
      (module: SystemModule, entityType: string, data?: Record<string, unknown>, name?: string) =>
        executeAction({
          module,
          action: "create",
          entityType,
    ...
    read: useCallback(
      (module: SystemModule, entityType: string, entityId?: string, name?: string) =>
        executeAction({
          module,
          action: "read",
          entityType,
    ...
    escalate: useCallback(
      (module: SystemModule, entityType: string, entityId: string, level?: string, name?: string) =>
        executeAction({
          module,
          action: "escalate",
          entityType,
    ...
    // Data Operations
    export: useCallback(
      (module: SystemModule, entityType: string, format?: string) =>
        executeAction({
          module,
          action: "export",
          entityType,
    ...
    import: useCallback(
      (module: SystemModule, entityType: string, data?: Record<string, unknown>) =>
        executeAction({
          module,
          action: "import",
          entityType,
    ...
    sync: useCallback(
      (module: SystemModule, entityType: string) =>
        executeAction({
          module,
          action: "sync",
          entityType,
...
export function createModuleActions(module: SystemModule) {
  return {
    ...
    enable: (entityType: string, entityId: string) => ({
      module,
      action: "enable" as SystemAction,
      entityType,
      entityId,
    }),
    disable: (entityType: string, entityId: string) => ({
      module,
      action: "disable" as SystemAction,
      entityType,
      entityId,
    }),
    suspend: (entityType: string, entityId: string) => ({
      module,
      action: "suspend" as SystemAction,
      entityType,
      entityId,
      requiresConfirmation: true,
    }),
    approve: (entityType: string, entityId: string) => ({
      module,
      action: "approve" as SystemAction,
      entityType,
      entityId,
    }),
    reject: (entityType: string, entityId: string, reason?: string) => ({
      module,
      action: "reject" as SystemAction,
      entityType,
      entityId,
      data: { reason },
    }),
    export: (entityType: string, format?: string) => ({
      module,
      action: "export" as SystemAction,
      entityType,
      data: { format },
    }),
    refresh: (entityType: string) => ({
      module,
      action: "refresh" as SystemAction,
      entityType,
    }),
  };
}
