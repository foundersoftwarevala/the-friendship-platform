...
const ENV = (
  ...
  a: string,
  b: string,
  plinth: MuseumEnvironment["plinth"],
  vibe: string,
): MuseumEnvironment => ({
  key,
  name,
...
export const ROLE_ENVIRONMENT: Record<RoleSlug, MuseumEnvironment> = {
  developer: ENV(
    "tech-lab",
    "Modern Technology Lab",
    "#38bdf8",
    "#0ea5e9",
    "brushed-steel",
    "Cold light, machined edges, engineered precision.",
  ),
  reseller: ENV(
    "exec-lounge",
    ...
    "#b45309",
    "leather",
    "Warm brass, stitched leather, private-club calm.",
  ),
  franchise: ENV(
    "global-hq",
    ...
    "#1e3a8a",
    "marble",
    "Atrium marble, glass towers, worldwide scale.",
  ),
  author: ENV(
    "publishing-studio",
    "Luxury Publishing Studio",
    "#a78bfa",
    "#6d28d9",
    "walnut",
    "Ink, gilt edges, hand-bound craftsmanship.",
  ),
  vendor: ENV(
    "marketplace-showroom",
    "Premium Marketplace Showroom",
    "#34d399",
    "#047857",
    "glass",
    "Lit vitrines, curated shelves, retail theatre.",
  ),
  affiliate: ENV(
    "network-center",
    ...
    "#0e7490",
    "brushed-steel",
    "Linked light paths and signal geometry.",
  ),
  influencer: ENV(
    "creator-studio",
    "Creator Studio",
    ...
    "#be185d",
    "glass",
    "Soft key lights, gradient haze, on-air energy.",
  ),
  creator: ENV(
    "design-studio",
    ...
    "#c2410c",
    "walnut",
    "Studio warmth, paper texture, pigment glow.",
  ),
  seo: ENV(
    "analytics-command",
    ...
    "#15803d",
    "obsidian",
    "Grid lines, telemetry sweep, quiet control.",
  ),
  support: ENV(
    "success-center",
    ...
    "#0369a1",
    "marble",
    "Open light, calm surfaces, human trust.",
  ),
  user: ENV(
    "member-hall",
    "Member Collection Hall",
    "#e2e8f0",
    "#64748b",
    "glass",
...
export const SHOWCASES: ShowcaseDef[] = [
  {
    ...
    assets: ROLE_TROPHY,
    collectionStyle: "Luxury Cabinet",
    material: "Polished gold & crystal",
    accent: "#facc15",
  },
  {
    slug: "award-gallery",
    ...
    assets: ROLE_AWARD,
    collectionStyle: "Premium Display Wall",
    material: "Brushed metal & glass",
    accent: "#f59e0b",
  },
  {
    slug: "passport-gallery",
    title: "Passport Gallery",
    kicker: "Gallery",
    ...
    collectionStyle: "Digital Safe",
    material: "Holographic laminate",
    accent: "#38bdf8",
  },
  {
    slug: "badge-museum",
    ...
    assets: ROLE_BADGE,
    collectionStyle: "Collector Album",
    material: "Hard enamel & steel",
    accent: "#a78bfa",
  },
  {
    slug: "medal-gallery",
    ...
    collectionStyle: "Achievement Archive",
    material: "Struck bronze & silk",
    accent: "#fb7185",
  },
  {
    slug: "certificate-hall",
    title: "Certificate Hall",
    kicker: "Hall",
    singular: "Certificate",
    suffix: "certificate",
    description: "Framed credentials in an executive library with gold engraving.",
    assets: ROLE_CERTIFICATE,
    collectionStyle: "Executive Library",
    material: "Cotton paper & gold foil",
    accent: "#e8d29a",
  },
  {
    slug: "legacy-museum",
    ...
    collectionStyle: "Executive Vault",
    material: "Aged gold & obsidian",
    accent: "#d4af6a",
  },
  {
    slug: "hall-of-fame-gallery",
    ...
    collectionStyle: "Founder Collection",
    material: "Marble & gilt",
    accent: "#fcd34d",
  },
  {
    slug: "membership-gallery",
    title: "Membership Gallery",
    kicker: "Gallery",
    ...
    collectionStyle: "Luxury Cabinet",
    material: "Anodised metal",
    accent: "#22d3ee",
  },
  {
    slug: "identity-gallery",
    title: "Identity Gallery",
    kicker: "Gallery",
    ...
    collectionStyle: "Digital Safe",
    material: "Polycarbonate & laser etch",
    accent: "#818cf8",
  },
  {
    slug: "verification-gallery",
    title: "Verification Gallery",
    kicker: "Gallery",
    singular: "Verification Shield",
    suffix: "shield",
  ...
  },
  {
    ...
    assets: ROLE_RANK,
    collectionStyle: "Premium Display Wall",
    material: "Cast metal & enamel",
    accent: "#60a5fa",
  },
  {
    slug: "reputation-gallery",
    title: "Reputation Gallery",
    kicker: "Gallery",
