...
function journey(
  narratives: [string, string, string, string, string, string, string, string],
): RoleJourneyStage[] {
  const labels = [
    "Starter",
    "Growing",
...
export const ROLES: RoleDNA[] = [
  ...
  },
  {
    ...
    successDefinition:
      "Consistent uptime, cleared queues, and incidents resolved before they escalate.",
    careerPath: [
      "Trainee Operator",
      "Operator",
      "Senior Operator",
