...
export const AUTHOR_STAGES: DeveloperStage[] = [
  {
    ...
    trophyShape: "cup",
    medalShape: "circle",
    passportMotif: "Rough Paper",
    badgeStyle: "Wax Dot",
    nameplate: "Etched Parchment",
    ribbon: ["#c9a37a", "#5a3a20"],
    unlock: "starter",
    bg: {
      gradient:
        "radial-gradient(1200px 500px at 20% 0%, rgba(201,163,122,0.14), transparent 60%), linear-gradient(160deg, oklch(0.235 0.036 258) 0%, oklch(0.185 0.034 258) 100%)",
      accent: "#c9a37a",
      glow: "rgba(201,163,122,0.5)",
      particle: "#e6c9a1",
    },
    rewards: [
  ...
  },
  {
    ...
    trophyShape: "flame",
    medalShape: "hexagon",
    passportMotif: "Ink-Splattered Bronze",
    badgeStyle: "Enamel Quill",
  ...
  },
  {
    ...
    material: "Silver Foil",
    trophyShape: "obelisk",
    medalShape: "shield",
    passportMotif: "Silver Foil Weave",
  ...
  },
  {
    ...
    trophyShape: "diamond",
    medalShape: "star",
    passportMotif: "Gold Leaf Manuscript",
  ...
  },
  {
    ...
    theme: "Platinum Feature",
    tagline: "On the front page. Curated by editors.",
    material: "Platinum",
    trophyShape: "orb",
    medalShape: "octagon",
    passportMotif: "Platinum Filigree",
  ...
  },
  {
    ...
    code: "STAGE 06",
    title: "Series Master",
    theme: "Crystal Volume",
    tagline: "A series that readers wait for.",
    material: "Crystal Glass",
    trophyShape: "prism",
    medalShape: "diamond",
    passportMotif: "Etched Crystal Manuscript",
    badgeStyle: "Beveled Glass",
    nameplate: "Frosted Crystal Slab",
    ribbon: ["#a78bfa", "#4b2ea5"],
    unlock: "diamond",
    bg: {
      gradient:
        "radial-gradient(1200px 500px at 40% 0%, rgba(167,139,250,0.14), transparent 60%), linear-gradient(160deg, oklch(0.235 0.036 258) 0%, oklch(0.185 0.034 258) 100%)",
      accent: "#a78bfa",
  ...
  },
  {
    n: 7,
    code: "STAGE 07",
    title: "Reader's Favorite",
    theme: "Titanium Ribbon",
    tagline: "Voted. Reviewed. Remembered.",
    material: "Titanium",
    trophyShape: "wing",
    medalShape: "gear",
    passportMotif: "Titanium Foil",
