...
export const VENDOR_STAGES: DeveloperStage[] = [
  {
    ...
    trophyShape: "cup",
    medalShape: "circle",
    passportMotif: "Market Grid",
    badgeStyle: "Copper Pin",
  ...
  },
  {
    ...
    trophyShape: "flame",
    medalShape: "hexagon",
    passportMotif: "Bronze Storefront Emboss",
    badgeStyle: "Enamel Storefront",
  ...
  },
  {
    n: 4,
    code: "STAGE 04",
    title: "Five-Star Vendor",
    theme: "Gold Storefront",
    tagline: "Five-star streak. Customers write love letters.",
    material: "Gold",
    trophyShape: "diamond",
    medalShape: "star",
    passportMotif: "Gold Storefront Leaf",
    ...
    bg: {
      gradient:
        "radial-gradient(1200px 500px at 30% 0%, rgba(52,211,153,0.14), transparent 60%), linear-gradient(160deg, oklch(0.235 0.036 258) 0%, oklch(0.185 0.034 258) 100%)",
      accent: "#34d399",
  ...
  },
  {
    ...
    theme: "Platinum Aisle",
    tagline: "Curated aisle. Priority placement.",
    material: "Platinum",
    trophyShape: "orb",
    medalShape: "octagon",
    passportMotif: "Platinum Aisle",
  ...
  },
  {
    n: 10,
    code: "STAGE 10",
    title: "Founding Vendor",
    theme: "Founder Marketplace",
    ...
    bg: {
      gradient:
        "radial-gradient(1600px 700px at 50% 0%, rgba(255,242,176,0.14), transparent 65%), radial-gradient(900px 500px at 50% 100%, rgba(52,211,153,0.14), transparent 60%), linear-gradient(160deg, oklch(0.235 0.036 258) 0%, oklch(0.185 0.034 258) 100%)",
      accent: "#fff2b0",
