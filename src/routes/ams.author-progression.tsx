...
export const Route = createFileRoute("/ams/author-progression")({
  head: () => ({
    meta: [
      { title: "Author Progression — 10 Stage Career" },
      {
        name: "description",
        content:
          "A cinematic 10-stage author career: from First Draft to Founding Author. Every stage unlocks a unique passport, trophy, medal, badge and certificate.",
      },
      { property: "og:title", content: "Author Progression — 10 Stage Career" },
      {
        property: "og:description",
        content:
          "Stage-by-stage timeline for the Author role, with unlock celebrations and premium sound cues.",
      },
