...
export const Route = createFileRoute("/ams/collections")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Curated sets of awards, badges, certificates, passports, stamps and trophies.",
      },
      ...
      rows={[
        {
          ...
          name: (
            <div className="flex items-center gap-2">
              <Layers className="h-4 w-4 text-accent-pink" />
              <span className="font-medium">Founding Collection</span>
            </div>
          ),
          kind: "Award",
          items: "12",
        ...
        {
          id: "co2",
          name: <span className="font-medium">Developer Journey</span>,
          kind: "Badge",
          items: "24",
          completions: "412",
        ...
        {
          id: "co3",
          name: <span className="font-medium">Winter Ascendant</span>,
          kind: "Trophy",
          items: "8",
          completions: "204",
          status: <StatusChip tone="info">Seasonal</StatusChip>,
        },
      ]}
    />
  );
