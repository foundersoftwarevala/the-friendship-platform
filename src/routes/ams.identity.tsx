  ...
  head: () => ({
    meta: [
      { title: "Identity Engine — AMS" },
      {
        name: "description",
        content:
          "Role motto, vision, mission, philosophy, signature, greeting, celebration and motivation language.",
      },
...
function Page() {
  return (
    <EngineDashboard
      ...
      filters={[
        { label: "Role", values: ["Developer", "Reseller", "Support", "SEO", "Creator", "Author"] },
      ]}
      columns={[
        { key: "role", label: "Role" },
      ...
      rows={[
        {
          ...
          signature: "// arch-01",
          celebration: "Neon commit rain",
          status: <StatusChip tone="success">Active</StatusChip>,
        },
        {
          id: "id2",
          role: <span className="font-medium">Reseller</span>,
          motto: "Every deal, a new door.",
          signature: "★ sales",
          celebration: "Coin cascade",
          status: <StatusChip tone="success">Active</StatusChip>,
        },
        {
          id: "id3",
          role: <span className="font-medium">Support</span>,
          motto: "We turn issues into trust.",
          signature: "🛡 support",
        ...
        {
          id: "id4",
          role: <span className="font-medium">SEO</span>,
          motto: "Rank the invisible.",
          signature: "↗ seo",
          celebration: "Ranking rocket",
          status: <StatusChip tone="success">Active</StatusChip>,
        },
      ]}
    />
