  ...
  head: () => ({
    meta: [
      { title: "Leaderboard — AMS" },
      {
        name: "description",
        content:
          "Global, department, seasonal, guild and role-specific leaderboards with anti-abuse.",
      },
      ...
      rows={[
        {
          id: "L1",
          rank: "1",
          user: <span className="font-medium">@arjun.k</span>,
          role: "Developer",
          score: "48,204",
          delta: "+2",
          status: <StatusChip tone="success">Rising</StatusChip>,
        },
        {
          id: "L2",
          rank: "2",
          user: <span className="font-medium">@meera.s</span>,
          role: "Reseller",
          score: "42,118",
          delta: "-1",
          status: <StatusChip tone="muted">Stable</StatusChip>,
        },
        {
          id: "L3",
          rank: "3",
          user: <span className="font-medium">@dev.rj</span>,
          role: "SEO",
          score: "38,412",
          delta: "+4",
          status: <StatusChip tone="success">Rising</StatusChip>,
        },
        {
          id: "L4",
          rank: "4",
          user: <span className="font-medium">@vivek.p</span>,
          role: "Support",
          score: "34,204",
          delta: "0",
          status: <StatusChip tone="muted">Stable</StatusChip>,
        },
        {
          id: "L5",
          rank: "5",
          user: <span className="font-medium">@shreya.n</span>,
          role: "Creator",
          score: "31,884",
          delta: "+1",
          status: <StatusChip tone="success">Rising</StatusChip>,
