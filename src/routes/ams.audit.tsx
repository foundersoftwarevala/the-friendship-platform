  ...
  return (
    <EngineDashboard
      ...
      rows={[
        {
          id: "a1",
          time: "2026-07-30 09:41",
          scope: "Achievement",
          action: "achievement.unlocked",
          actor: "system",
          target: "priya@demo.app · Recognition Legend",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a2",
          time: "2026-07-30 09:36",
          scope: "XP",
          action: "xp.granted (+250)",
          actor: "rules-engine",
          target: "arjun@demo.app",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a3",
          time: "2026-07-30 09:22",
          scope: "Reward",
          action: "reward.claim.approved",
          actor: "admin@demo.app",
          target: "Claim #48213",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a4",
          time: "2026-07-30 09:05",
          scope: "Admin",
          action: "role.assigned (admin)",
          actor: "superadmin@demo.app",
          target: "meera@demo.app",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a5",
          time: "2026-07-30 08:58",
          scope: "User",
          action: "profile.updated",
          actor: "kabir@demo.app",
          target: "self",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          ...
          scope: "Reward",
          action: "reward.claim.rejected",
          actor: "admin@demo.app",
          target: "Claim #48198",
          outcome: <StatusChip tone="warn">Denied</StatusChip>,
        },
        {
          id: "a7",
          ...
          actor: "scheduler",
          target: "Global · Weekly",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a8",
          time: "2026-07-30 08:12",
          scope: "Admin",
          action: "policy.update (xp cap)",
          actor: "superadmin@demo.app",
          target: "XP Engine",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a9",
          time: "2026-07-30 07:57",
          scope: "XP",
          action: "xp.revoked (-120)",
          actor: "admin@demo.app",
          target: "rahul@demo.app",
          outcome: <StatusChip tone="warn">Reversal</StatusChip>,
        },
        {
          id: "a10",
          time: "2026-07-30 07:40",
          scope: "System",
          action: "notification.dispatch",
          actor: "notification-engine",
          target: "Rank promotion · 3,412 users",
          outcome: <StatusChip tone="success">Success</StatusChip>,
        },
        {
          id: "a11",
          time: "2026-07-30 07:18",
          scope: "User",
          action: "login.failed",
          actor: "unknown",
          target: "vendor@demo.app",
          outcome: <StatusChip tone="danger">Failed</StatusChip>,
        },
        {
          id: "a12",
          time: "2026-07-30 06:55",
          scope: "Achievement",
