...
export const Route = createFileRoute("/ams/hall-of-fame")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Legendary users, historic achievements, career milestones and digital museum.",
      },
      ...
      rows={[
        {
          ...
          user: (
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">@arjun.k</span>
            </div>
          ),
          role: "Developer",
          since: "2024-01-12",
          awards: "48",
          tier: <StatusChip tone="warn">Founder</StatusChip>,
        },
        {
          id: "h2",
          ...
          since: "2024-06-04",
          awards: "36",
          tier: <StatusChip tone="info">Legend</StatusChip>,
        },
        {
          id: "h3",
