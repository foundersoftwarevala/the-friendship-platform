  ...
  head: () => ({
    meta: [
      { title: "Signature Collections — Software Vala AMS" },
      {
        name: "description",
        content:
          "Career-long signature collections: ten stages per role across trophies, awards, badges, medals, passports, certificates and more.",
      },
      { property: "og:title", content: "Signature Collections — Software Vala AMS" },
      {
        property: "og:description",
        content:
          "Build an entire professional career collection — 10 career-stage pieces per role, per collectible type.",
      },
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          {CAREER_STAGES.map((s, i) => (
            <div key={s.key} className="rounded-xl border border-border/60 bg-card p-3">
              ...
              <div className="mt-1 text-sm font-semibold" style={{ color: s.hue }}>
                {s.label}
              </div>
