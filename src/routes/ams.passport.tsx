  ...
  head: () => ({
    meta: [
      { title: "Passport Engine — AMS" },
      {
        name: "description",
        content:
          "Unique passport per role — cover, number, stamps, timeline, verification, expiry, renewal.",
      },
  ...
  return (
    <EngineDashboard
      ...
      filters={[
        {
          label: "Role",
          values: ["Developer", "Reseller", "Franchise", "Author", "Support", "SEO"],
        },
      ...
      rows={[
        {
          ...
          name: (
            <div className="flex items-center gap-2">
              <BookMarked className="h-4 w-4 text-accent-emerald" />
              <span className="font-medium">Developer Passport</span>
            </div>
          ),
          role: "Developer",
          level: "Gold",
        ...
        {
          id: "p2",
          name: <span className="font-medium">Reseller Passport</span>,
          role: "Reseller",
          level: "Diamond",
          stamps: "36",
          verified: "Yes",
        ...
        {
          id: "p3",
          name: <span className="font-medium">Founder Passport</span>,
          role: "Founder",
          level: "Elite",
          stamps: "84",
          verified: "Yes",
