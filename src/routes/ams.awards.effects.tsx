...
export const Route = createFileRoute("/ams/awards/effects")({
  head: () => ({
    meta: [
      { title: "Effects Library — AMS" },
      {
        name: "description",
        content:
          "Reusable animations and audio cues for every unlock, level-up, rank-up and reward across the platform.",
      },
  ...
  const effects: Effect[] = [
    {
      ...
      description: "Classic celebratory confetti.",
      icon: Sparkles,
      run: () => celebrate({ kind: "surprise", title: "Confetti", subtitle: "Surprise reward" }),
    },
    {
      key: "coin-rain",
      title: "Coin Rain",
      description: "Gold coin shower.",
      icon: Coins,
      run: () => celebrate({ kind: "firstSale", title: "Coin Rain", subtitle: "Economy reward" }),
    },
    {
      key: "fireworks",
      title: "Fireworks",
      description: "Sky-bursts for rank ups.",
      icon: Star,
      run: () => celebrate({ kind: "rankUp", title: "Fireworks", subtitle: "Rank elevated" }),
    },
    {
      key: "badge-unlock",
      title: "Badge Unlock",
      ...
      icon: AwardIcon,
      run: () => celebrate({ kind: "badge", title: "New Badge", subtitle: "Badge unlocked" }),
    },
    {
      key: "trophy-unlock",
      title: "Trophy Unlock",
      description: "Full-screen unveil.",
      icon: Trophy,
      run: () => celebrate({ kind: "trophy", title: "New Trophy", subtitle: "Trophy unlocked" }),
    },
    {
      key: "xp-pop",
      title: "XP Pop",
      description: "Floating XP gain.",
      icon: Zap,
      run: () => celebrate({ kind: "levelUp", title: "+250 XP", xp: 250 }),
    },
    {
      key: "reward-claim",
      title: "Reward Claim",
      description: "Reward gift animation.",
      icon: Gift,
      run: () =>
            ...
            return (
              <div key={e.key} className="surface-card p-4 flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <span className="grid h-8 w-8 place-items-center rounded-md bg-trophy/15 text-trophy">
