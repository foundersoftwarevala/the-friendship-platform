...
function DepartmentMotif({
  ...
  switch (motif) {
    ...
    case "shield":
      return (
        <path
          d="M60 22 L92 34 V62 Q92 88 60 100 Q28 88 28 62 V34 Z"
          stroke={accent}
          strokeOpacity={op}
          strokeWidth="0.8"
          fill={`${accent}10`}
    ...
    case "crown":
      return (
        <path
          d="M30 70 L40 40 L50 60 L60 32 L70 60 L80 40 L90 70 Z"
          stroke={accent}
          strokeOpacity={op}
          strokeWidth="0.8"
          fill={`${accent}12`}
    ...
    case "diamond":
      return (
        <path
          d="M60 22 L94 60 L60 98 L26 60 Z"
          stroke={accent}
          strokeOpacity={op}
          strokeWidth="0.8"
          fill={`${accent}10`}
    ...
    case "prism":
      return (
        <g>
          <polygon
            points="60,24 96,84 24,84"
            stroke={accent}
            strokeOpacity={op}
            fill={`${accent}10`}
          />
          <line x1="60" y1="24" x2="60" y2="84" stroke={accent} strokeOpacity={op} />
        </g>
      );
    case "lock":
      return (
        <g>
          <rect
            ...
            fill={`${accent}10`}
          />
          <path d="M48 54 V42 a12 12 0 0124 0 V54" stroke={accent} strokeOpacity={op} fill="none" />
        </g>
      );
    case "gear": {
      ...
      return (
        <g>
          <circle cx="60" cy="60" r="34" stroke={accent} strokeOpacity={op} fill="none" />
          {teeth}
        </g>
      );
    }
  ...
  switch (type) {
    case "trophy":
      return (
        <g filter="url(#soft)">
          <path
            d="M44 44 V36 H76 V44 Q76 64 60 70 Q44 64 44 44 Z"
            fill={g}
            stroke={color}
            strokeWidth="0.8"
          />
    ...
    case "badge":
      return (
        <g filter="url(#soft)">
          <polygon
            points="60,32 80,44 80,68 60,84 40,68 40,44"
            fill={g}
            stroke={color}
            strokeWidth="0.8"
          />
    ...
    case "rank":
      return (
        <g filter="url(#soft)">
          <path
            d="M36 72 L60 36 L84 72 L72 80 L60 70 L48 80 Z"
            fill={g}
            stroke={color}
            strokeWidth="0.8"
          />
    ...
    case "streak":
      return (
        <g filter="url(#soft)">
          <path
            d="M60 32 Q72 50 68 60 Q78 56 76 70 Q72 82 60 84 Q48 82 44 70 Q42 56 52 60 Q48 50 60 32 Z"
            fill={g}
            stroke={color}
            strokeWidth="0.8"
          />
    ...
    default:
      return (
        <g filter="url(#soft)">
          <polygon
            points="60,32 67,52 88,52 71,64 78,84 60,72 42,84 49,64 32,52 53,52"
            fill={g}
            stroke={color}
            strokeWidth="0.8"
          />
  ...
  const petals = Array.from({ length: count }, (_, i) => {
    ...
    return (
      <line
        ...
        stroke={color}
        strokeOpacity={0.4 + intensity * 0.05}
        strokeWidth={0.6}
...
export function ProceduralEmblem({ award, size = 160, className }: ProceduralEmblemProps) {
  ...
  const seed = useMemo(
    () => hash(`${award.id}:${award.type}:${rarity}:${award.department ?? "none"}`),
    [award.id, award.type, rarity, award.department],
  );
    ...
    >
      <defs>
        ...
        <linearGradient id={`grad-trophy`} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor={meta.hue} />
          <stop offset="100%" stopColor={accent} />
        </linearGradient>
        <linearGradient id={`grad-badge`} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor={accent} />
          <stop offset="100%" stopColor={meta.hue} />
        </linearGradient>
