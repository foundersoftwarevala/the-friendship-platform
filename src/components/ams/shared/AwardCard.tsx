...
export function AwardCard({
  ...
  return (
    <Link
      ...
      style={{
        boxShadow:
          meta.tier >= 5 ? `0 0 0 1px ${meta.hue}33, 0 18px 40px -22px ${meta.glow}` : undefined,
      }}
    >
        ...
        <div className="stage-3d-object relative">
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <div
              ...
              style={{
                background:
                  "linear-gradient(100deg, transparent, color-mix(in oklab, white 38%, transparent), transparent)",
                mixBlendMode: "screen",
                filter: "blur(2px)",
              }}
            />
      ...
      <div className="mt-auto flex items-center justify-between text-[11px] text-muted-foreground">
        ...
        <span className="font-mono tabular-nums" style={{ color: meta.hue }}>
          +{award.rewards.xp.toLocaleString()} XP
        </span>
      </div>
      {footer}
    </Link>
