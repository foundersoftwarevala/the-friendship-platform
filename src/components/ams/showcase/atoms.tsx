  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(90deg, transparent, ${theme.primary}, ${theme.accent}, ${theme.primary}, transparent)`,
        }}
      />
      {/* chip */}
      <div
        className="absolute left-6 top-10 h-10 w-14 rounded"
      ...
      <div
        className="absolute left-6 bottom-16 text-[9px] tracking-[0.3em] uppercase"
        style={{ color: `${theme.primary}bb` }}
      >
        {tier}
      </div>
      <div
        className="absolute left-6 bottom-8 text-lg text-foreground font-medium tracking-wide"
        style={{ fontFamily: theme.displayFont }}
      >
        {name}
      </div>
      <div
        className="absolute left-6 bottom-3 text-[10px] font-mono"
        style={{ color: `${theme.primary}cc` }}
      >
        {id}
      </div>
      <div
        className="absolute right-4 bottom-3 text-[9px] tracking-widest uppercase"
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      >
        ...
        />
        <div
          className="absolute inset-6 rounded border"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 text-center px-6">
          ...
          >
            {theme.environmentLabel}
          </div>
        </div>
        {/* metallic corner */}
        <div
          className="absolute top-3 right-3 h-6 w-6 rounded-sm"
          style={{ background: theme.metallic }}
        />
      </div>
      ...
      >
        ...
        <div className="relative flex items-start justify-between">
          <div>
            ...
            <div className="mt-1 text-xl text-foreground" style={{ fontFamily: theme.displayFont }}>
              {name}
            </div>
            <div className="text-[10px] font-mono mt-0.5" style={{ color: `${theme.primary}cc` }}>
              {id}
            </div>
          </div>
          {/* QR-style block */}
          <div
            className="h-16 w-16 grid grid-cols-8 grid-rows-8 gap-[1px] p-1 rounded"
            style={{ background: `${theme.primary}18`, border: `1px solid ${theme.primary}44` }}
          >
            {Array.from({ length: 64 }).map((_, i) => (
              <div
                key={i}
                style={{ background: Math.random() > 0.55 ? theme.primary : "transparent" }}
              />
            ))}
          </div>
        </div>
        ...
        <div className="relative grid grid-cols-3 gap-3">
          {["FIRST STEP", "VERIFIED", "CEREMONY"].map((s, i) => (
            <div
              key={s}
              className="aspect-square rounded-full border-2 flex items-center justify-center rotate-[-6deg]"
              style={{
...
export function Medal({ theme, label }: { theme: RoleTheme; label: string }) {
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <svg
        viewBox="0 0 160 160"
        className="w-32 -mt-6 trophy-float"
      ...
      >
        ...
        {(() => {
          ...
          switch (shape) {
            case "circle":
              return <circle cx="80" cy="80" r="60" fill={fill} />;
            case "hexagon":
              return <polygon points="80,20 138,50 138,110 80,140 22,110 22,50" fill={fill} />;
            case "shield":
              return (
                <path d="M80 20 L138 40 V90 Q138 130 80 145 Q22 130 22 90 V40 Z" fill={fill} />
              );
            case "star":
              return (
                <path
                  d="M80 15 L96 60 L142 60 L104 88 L120 132 L80 106 L40 132 L56 88 L18 60 L64 60 Z"
                  fill={fill}
                />
              );
            case "octagon":
              ...
              return (
                <g>
                  ...
                  {Array.from({ length: 12 }).map((_, i) => {
                    ...
                    const x = 80 + Math.cos(a) * 68;
                    const y = 80 + Math.sin(a) * 68;
                    return (
                      <rect
                        key={i}
                        x={x - 6}
                        ...
                        height="12"
                        fill={fill}
                        transform={`rotate(${(a * 180) / Math.PI + 45} ${x} ${y})`}
                      />
                    );
                  })}
            ...
            case "diamond":
              return <polygon points="80,15 145,80 80,145 15,80" fill={fill} />;
            case "sun":
              return (
                <g>
            ...
            case "phoenix":
              return (
                <g>
                  <circle cx="80" cy="80" r="50" fill={fill} />
                  <path
                    d="M80 40 C 50 60, 40 90, 60 120 C 70 100, 80 100, 80 80 C 80 100, 90 100, 100 120 C 120 90, 110 60, 80 40 Z"
                    fill={theme.accent}
                    opacity="0.9"
                  />
                </g>
        ...
        <text
          ...
          fontSize="13"
          fill={theme.ink}
          style={{ fontFamily: theme.displayFont, letterSpacing: 2 }}
        >
          {label.toUpperCase()}
        </text>
      </svg>
...
export function Badge({ theme, label }: { theme: RoleTheme; label: string }) {
  ...
  return (
    <svg
      viewBox="0 0 140 160"
      className="w-24"
      style={{ filter: `drop-shadow(0 10px 20px ${theme.glow})` }}
    >
      <defs>
      ...
      {(() => {
        ...
        switch (shape) {
          case "shield":
            return (
              <path
                d="M70 10 L125 30 V80 Q125 130 70 150 Q15 130 15 80 V30 Z"
                fill={fill}
                stroke={theme.accent}
                strokeWidth="2"
              />
          ...
          case "hex":
            return (
              <polygon
                points="70,10 125,40 125,110 70,140 15,110 15,40"
                fill={fill}
                stroke={theme.accent}
                strokeWidth="2"
              />
          ...
          case "circle":
            return (
              <circle cx="70" cy="75" r="60" fill={fill} stroke={theme.accent} strokeWidth="2" />
            );
          case "starburst":
            return (
              <g>
                <path
                  d="M70 8 L84 46 L124 46 L92 70 L106 110 L70 86 L34 110 L48 70 L16 46 L56 46 Z"
                  fill={fill}
                  stroke={theme.accent}
                  strokeWidth="2"
                />
            ...
            return (
              <g>
                ...
                {Array.from({ length: 10 }).map((_, i) => {
                  ...
                  const x = 70 + Math.cos(a) * 66;
                  const y = 75 + Math.sin(a) * 66;
                  return (
                    <rect key={i} x={x - 5} y={y - 5} width="10" height="10" fill={theme.primary} />
                  );
                })}
              </g>
            );
          ...
          case "crest":
            return (
              <path
                d="M70 10 L120 30 L118 90 Q118 118 70 150 Q22 118 22 90 L20 30 Z"
                fill={fill}
                stroke={theme.accent}
                strokeWidth="2"
              />
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-4">
        <div
          className="h-16 w-16 rounded-md flex items-center justify-center text-3xl"
        ...
        <div>
          ...
          <div className="text-lg text-foreground" style={{ fontFamily: theme.displayFont }}>
            {title}
          </div>
          <div
            className="text-[11px]"
            style={{ color: `${theme.accent}cc`, fontFamily: theme.bodyFont }}
          >
            {subtitle}
          </div>
        </div>
...
export function Certificate({
  ...
  return (
    <div
      className="relative aspect-[1.414/1] rounded-lg overflow-hidden border-8 p-6 flex flex-col items-center justify-center text-center"
      style={{
    ...
    >
      ...
      {["top-left", "top-right", "bottom-left", "bottom-right"].map((pos) => (
        <div
          key={pos}
          className={`absolute h-8 w-8 ${pos.replace("-", "-")}`}
          style={{
      ...
      <div className="relative">
        <div className="text-[10px] tracking-[0.4em] uppercase" style={{ color: theme.ink }}>
          Certificate of Achievement
        </div>
        <div className="mt-3 text-3xl" style={{ color: theme.ink }}>
          {holder}
        </div>
        <div
          className="mt-1 text-[11px] italic"
          style={{ color: `${theme.ink}bb`, fontFamily: theme.bodyFont }}
        >
          is hereby recognized as
        </div>
        <div className="mt-2 text-xl" style={{ color: theme.secondary }}>
          {title}
        </div>
        <div className="mt-3 mx-auto h-px w-40" style={{ background: theme.ink }} />
        <div
          className="mt-4 flex items-center justify-between gap-8 text-[10px] uppercase tracking-widest"
          style={{ color: `${theme.ink}aa` }}
        >
          <div>
            <div
          ...
          <div
            ...
            style={{
              ...
              background: `radial-gradient(${theme.primary}44, transparent 70%)`,
            }}
          >
            <span style={{ color: theme.secondary, fontFamily: theme.displayFont }}>
              {theme.glyphIcon}
            </span>
          </div>
          <div>
            <div
              className="h-6 w-24 mx-auto grid grid-cols-6 grid-rows-6 gap-[1px]"
              style={{ background: `${theme.ink}18`, padding: 1 }}
            >
              {Array.from({ length: 36 }).map((_, i) => (
                <div
                  key={i}
                  style={{ background: Math.random() > 0.5 ? theme.ink : "transparent" }}
                />
              ))}
            </div>
...
export function TrophyCabinet({
  ...
  return (
    ...
    >
      <div
        className="relative grid grid-cols-4 divide-x divide-y"
        style={{ borderColor: `${theme.primary}22` }}
      >
        {tiers.map((t, i) => (
          <div
            key={i}
            className="aspect-square relative flex items-end justify-center p-3"
            style={{
          ...
          >
            ...
            <svg
              viewBox="0 0 40 60"
              className="h-16 trophy-float"
              style={{
                animationDelay: `${i * 0.35}s`,
                filter: `drop-shadow(0 6px 12px ${t.hue}88)`,
              }}
            >
              <defs>
              ...
              <rect
                ...
                height="6"
                rx="1"
                fill={`url(#cab-${theme.slug}-${i})`}
              />
            </svg>
            <div
              className="absolute bottom-1 left-2 right-2 text-[8px] uppercase tracking-widest text-center truncate"
              style={{ color: t.hue }}
            >
              {t.label}
            </div>
...
export function AvatarFrame({ theme, initials }: { theme: RoleTheme; initials: string }) {
  return (
    <div className="relative h-28 w-28">
      {/* rotating outer ring */}
      <div
        className="absolute inset-0 rounded-full trophy-rotate"
        style={{
