...
type Props = {
  shape: DeveloperStage["trophyShape"];
  accent: string;
  id: string;
  className?: string;
};
  ...
  switch (shape) {
    ...
    case "flame":
      body = (
        <>
          <path
            d="M100 20 C 70 60, 60 90, 80 130 C 90 110, 100 105, 100 90 C 110 110, 130 120, 120 140 C 115 155, 100 165, 100 190 C 130 175, 150 145, 145 110 C 135 80, 120 55, 100 20 Z"
            fill={`url(#${gradId})`}
          />
    ...
    case "crown":
      body = (
        <>
          <path
            d="M50 100 L70 40 L90 90 L110 40 L130 90 L150 40 L165 100 L155 160 L45 160 Z"
            fill={`url(#${gradId})`}
          />
    ...
    case "wing":
      body = (
        <>
          <path
            d="M100 30 C 60 60, 30 90, 40 130 C 60 120, 80 110, 100 100 C 120 110, 140 120, 160 130 C 170 90, 140 60, 100 30 Z"
            fill={`url(#${gradId})`}
          />
          <path
            d="M100 30 L100 180"
    ...
    case "star":
      body = (
        <>
          <path
            d="M100 20 L118 76 L176 76 L128 108 L146 166 L100 132 L54 166 L72 108 L24 76 L82 76 Z"
            fill={`url(#${gradId})`}
          />
